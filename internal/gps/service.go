...
func (s *GPSService) ProcessUpdate(ctx context.Context, update *GPSUpdate) (*LocationState, error) {
	// --- 1. Rate limit ---
...
func (s *GPSService) GetLocation(ctx context.Context, tripID int64) (*LocationState, error) {
...
func (s *GPSService) persistAndPublish(state *LocationState, deviation float64) {
